module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    const transaction = await queryInterface.sequelize.transaction();
    try {
      await queryInterface.removeColumn('schemes', 'organizationId', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('applications', 'organizationId', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('schemes', 'category', { transaction });

      await queryInterface.removeColumn('schemes', 'description', {
        transaction,
      });

      await queryInterface.removeColumn('schemes', 'name', { transaction });
      ...
      await queryInterface.removeColumn('applications', 'schemeId', {
        transaction,
      });
