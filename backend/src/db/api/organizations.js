...
module.exports = class OrganizationsDBApi {
  ...
  static async findBy(where, options) {
    ...
    output.applications_organization =
      await organizations.getApplications_organization({
        transaction,
      });
    ...
    output.schemes_organization = await organizations.getSchemes_organization({
      transaction,
    });
