...
router.get(
  ...
  wrapAsync(async (req, res) => {
    ...
    const payload = await ApplicationsDBApi.findAll(req.query, globalAccess);
    if (filetype && filetype === 'csv') {
      const fields = ['id', 'application_date'];
      const opts = { fields };
      try {
...
router.get(
  '/:id',
  wrapAsync(async (req, res) => {
    const payload = await ApplicationsDBApi.findBy({ id: req.params.id });
