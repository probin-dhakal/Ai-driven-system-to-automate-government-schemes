...
const config = {
  gcloud: {
    bucket: 'fldemo-files',
    hash: '39a8c9f816267d3d614610718217a7e9',
  },
  bcrypt: {
    saltRounds: 12,
  },
  ...
  uploadDir: os.tmpdir(),
  email: {
    from: 'Ai driven system to automate government schemes <app@flatlogic.app>',
  ...
  project_uuid: '32fca6fb-8d12-4185-bab9-d8602854f635',
  flHost:
...
config.pexelsQuery = 'path through a forest';
config.host =
