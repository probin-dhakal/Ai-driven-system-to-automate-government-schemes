...
import { create } from '../../stores/schemes/schemesSlice';
...
SchemesNew.getLayout = function getLayout(page: ReactElement) {
  return (
    <LayoutAuthenticated permission={'CREATE_SCHEMES'}>
      {page}
    </LayoutAuthenticated>
  );
};

export default SchemesNew;
