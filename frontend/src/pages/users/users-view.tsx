    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox>
          ...
          <>
            <p className={'block font-bold mb-2'}>Applications User</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.applications_user &&
                      Array.isArray(users.applications_user) &&
                      users.applications_user.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
                            router.push(
              ...
              {!users?.applications_user?.length && (
                <div className={'text-center py-4'}>No data</div>
              )}
            </CardBox>
          </>
