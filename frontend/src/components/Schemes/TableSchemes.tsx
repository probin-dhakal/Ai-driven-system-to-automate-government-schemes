...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/schemes/schemesSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureSchemesCols';
...
const TableSampleSchemes = ({
  ...
  const {
    ...
    loading,
    count,
    notify: schemesNotify,
    refetch,
  } = useAppSelector((state) => state.schemes);
  ...
  useEffect(() => {
    if (schemesNotify.showNotification) {
      notify(schemesNotify.typeNotification, schemesNotify.textNotification);
    }
  }, [schemesNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/schemes/schemes-view/?id=${id}`);
  };
...
export default TableSampleSchemes;
