...
const ListSchemes = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_SCHEMES');
              ...
              >
                ...
                >
                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-500 '}>SchemeName</p>
                ...
                <ListActionsPopover
                  ...
                  onEdit={onEdit}
                  itemId={item.id}
                  pathEdit={`/schemes/schemes-edit/?id=${item.id}`}
                  pathView={`/schemes/schemes-view/?id=${item.id}`}
